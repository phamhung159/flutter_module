...
import 'package:flutter_module/presentation/lib/src/group_call_widget.dart';
...
import 'package:flutter_module/presentation/lib/src/single_call_widget.dart';
        ...
        children: [
          Container(
            ...
            child: InkWell(
              child: Image(
                image: NetworkImage(
                  SettingsConfig.avatar.isNotEmpty
        ...
        children: [
          Row(
            ...
            children: [
              ...
              SizedBox(
                width:
                    _calculateTextWidth('TRTC', const TextStyle(fontSize: 32)) >
